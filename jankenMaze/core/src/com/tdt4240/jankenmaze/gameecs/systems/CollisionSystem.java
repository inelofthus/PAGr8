...
public class CollisionSystem extends EntitySystem {
    ...
    public void collisionWithWall(Entity player, Rectangle wall){
        com.tdt4240.jankenmaze.gameecs.components.VelocityComponent vc = ComponentMapper.getFor(com.tdt4240.jankenmaze.gameecs.components.VelocityComponent.class).get(player);
        com.tdt4240.jankenmaze.gameecs.components.PositionComponent pc = ComponentMapper.getFor(com.tdt4240.jankenmaze.gameecs.components.PositionComponent.class).get(player);
        if (vc.x!=0){
            if(vc.x>0){
